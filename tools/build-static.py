...
for name in ['index.html','404.html','styles.css','script.js','world.css','world.js','book-turn.js','map-panels.js','robots.txt','sitemap.xml','app-ads.txt','notice.json','version.json','.nojekyll']:
